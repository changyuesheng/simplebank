...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getAccountFoeUpdateStmt, err = db.PrepareContext(ctx, getAccountFoeUpdate); err != nil {
		return nil, fmt.Errorf("error preparing query GetAccountFoeUpdate: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getAccountFoeUpdateStmt != nil {
		if cerr := q.getAccountFoeUpdateStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getAccountFoeUpdateStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getAccountFoeUpdateStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getAccountFoeUpdateStmt: q.getAccountFoeUpdateStmt,
